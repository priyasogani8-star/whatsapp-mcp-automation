...
exports.PollValidator = void 0;
class PollValidator {
    /**
     * VALIDATE POLL CREATION
     */
    validatePollCreation(request) {
        // Validate question
     ...
     */
    validateSingleChoiceVote(request, poll) {
     ...
     */
    validateMultipleChoiceVote(request, poll) {
        const selectionCount = request.selectedChoices?.length || 0;
        // Check min selections
        if (selectionCount < poll.minSelections) {
            throw new Error(`Must select at least ${poll.minSelections} option(s). You selected ${selectionCount}.`);
        }
        // Check max selections
        if (selectionCount > poll.maxSelections) {
            throw new Error(`Cannot select more than ${poll.maxSelections} option(s). You selected ${selectionCount}.`);
        }
     ...
     */
    validateMultipleChoiceConstraints(poll) {
...
exports.PollValidator = PollValidator;
//# sourceMappingURL=pollValidator.js.map